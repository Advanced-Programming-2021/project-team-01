...
public enum ConsoleCommands {
    ...
    ADD_CARD("^deck add-card card (?<cardName>[\\w\\s']+) deck (?<deckName>[\\w\\s']+)(?<side> side)*$",
            "^deck add-card(?<side> side)* card (?<cardName>[\\w\\s']+) deck (?<deckName>[\\w]+)$",
            "^deck add-card card (?<cardName>[\\w\\s']+)(?<side> side)* deck (?<deckName>[\\w]+)$",
    ...
    REMOVE_CARD("^deck rm-card card (?<cardName>[\\w\\s']+) deck (?<deckName>[\\w]+)(?<side> side)*$",
            "^deck rm-card card (?<cardName>[\\w\\s']+)(?<side> side)* deck (?<deckName>[\\w]+)$",
            "^deck rm-card(?<side> side)* card (?<cardName>[\\w\\s']+) deck (?<deckName>[\\w]+)$",
            "^deck rm-card deck (?<deckName>[\\w]+) card (?<cardName>[\\w\\s']+)(?<side> side)*$",
            "^deck rm-card deck (?<deckName>[\\w]+)(?<side> side)* card (?<cardName>[\\w\\s']++)$",
